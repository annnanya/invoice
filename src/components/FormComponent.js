...
const FormComponent = () => {
    ...
    const onSubmit = (values) => {
        ...
        localStorage.setItem("form", JSON.stringify(initialValues));
                    ...
                    <Form className="invoice-form">
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                <Field as="select" name="purchaseOrderNumber" className="form-control">
                            ...
                            <div className="two-column-layout">
                                <div className="form-group">
                                    ...
                                    <Field type="text" name="invoiceNumber" className="form-control" />
                                    <ErrorMessage name="invoiceNumber" component="div" className="error" />
                                </div>
                                <div className="form-group">
                                    <label>Invoice Date  <span>*</span></label>
                                    <Field type="date" name="invoiceDate" className="form-control" />
                                ...
                                <div className="form-group">
                                    ...
                                    <Field as="select" name="paymentTerms" className="form-control">
                                ...
                                <div className="form-group">
                                    ...
                                    <Field type="date" name="invoiceDueDate" className="form-control" />
                                </div>
                                <div className="form-group">
                                    <label>GL Post Date <span>*</span></label>
                                    <Field type="date" name="glPostDate" className="form-control" />
                                </div>
                            </div>
                            <div className="description">
                                <div className="form-group">
                                    <label>Invoice Description <span>*</span></label>
                                    <Field type="text" name="invoiceDescription" className="form-control" />
                                </div>
                            </div>
                        ...
                        <div className="form-section">
                            ...
                            <div className="two-column-layout">
                                <div className="form-group">
                                    ...
                                    <Field type="number" name="lineAmount" className="form-control" />
                                ...
                                <div className="form-group">
                                    ...
                                    <Field as="select" name="account" className="form-control">
                            ...
                            <div className="description">
                                <div className="form-group">
                                    ...
                                    <Field type="text" name="expenseDescription" className="form-control" />
                                </div>
                            </div>
                        ...
                        <div className="comments-section">
                            ...
                            <div className="form-group">
                                <Field type="text" name="comments" placeholder="Add comments and use @Name to tag someone" className="form-control" />
                            </div>
                        </div>
